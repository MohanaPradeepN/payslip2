      ...
      <ul class="nav navbar-nav navbar-right">
		...
		<div>
        			...
        			<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
           				<li class="nav-item"><a class="nav-link"  id="pills-deletecourse-tab" data-toggle="pill" href="#deletecourse" role="tab" aria-controls="pills-deletecourse" aria-selected="false" style="padding-top: 0px;padding-left: 0px;padding-right: 0px;padding-bottom: 0px;"><label class="btn btn-default center-block" style="padding-left: 0px;padding-top: 0px;padding-right: 0px;padding-bottom: 0px;"><input type="button" value="Add course"></label></a></li>
  			...
  			<hr>
				  ...
				  <form action="addcourse" method="post" ModelAttribute="addcourse">
				   <div class="container">
				   		...
				   		<div class="row">
				   				...
				   				<center><table>
				   					...
				   					<tr><th>Course code :</th><td><input type="textbox" name="course_id" id="add_course" class="form-control"  placeholder="Course code"/></td></tr>
									...
									<tr><th>Semester :</th><td><select id="add_course" name="semester" class="form-control">
				   					...
				   					<tr><td colspan="2" style="text-align:center;"><input id="button_add" type="submit"  class="form-control" value="Add"/></td></tr>
				   				</table></center>
				   				</div>
				   			<div class="col-lg-2 col-sm-0 col-md-1 col-xs-0">
				   				</div>
