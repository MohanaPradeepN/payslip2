      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="logout" style="color:black;"><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>
           			...
           			<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
           				...
           				<li class="nav-item"><a class="nav-link"  id="pills-deletecourse-tab" data-toggle="pill" href="#deletecourse" role="tab" aria-controls="pills-deletecourse" aria-selected="false" style="padding-top: 0px;padding-left: 0px;padding-right: 0px;padding-bottom: 0px;"><a><label class="btn btn-default center-block" style="padding-left: 0px;padding-top: 0px;padding-right: 0px;padding-bottom: 0px;"><input type="submit" value="Delete course"></label></a></li>
           			</ul>
  			...
  			<hr>
					...
					<form action="deletecourse" method="post" modelAttribute="deletecourse">
						<div class="container">
							<div class="row">
								<div class="col-lg-2 col-sm-0 col-md-1 col-xs-0">
				   				...
				   				<center><table>
				   					...
				   					<tr><th>Course code :</th><td><input id="add_course" name="course_code_delete" type="text" placeholder="Enter the course code to delete" class="form-control"/></td></tr>
				   					
				   					
				   					<tr><td colspan="2" style="text-align:center;"><input id="button_delete" type="submit" value="delete" class="form-control"></td></tr>
				   				</table></center>
				   				</div>
				   			<div class="col-lg-2 col-sm-0 col-md-1 col-xs-0">
				   				</div>
