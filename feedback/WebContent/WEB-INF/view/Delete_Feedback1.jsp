      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="logout" style="color:black;"><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>
        			...
        			<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
           				...
           				<li class="nav-item"> <form action="Delete_Feedback1"><input type="submit" value="Delete Feedback"></form></li>
           			</ul>
				   ...
				   <%for(int i=0;i<b.size();i++){ %>
					...
					<div class="container">
							<div class="row">
								...
								<div class="col-lg-6" id="feedback1" style="text-align:center;">
								<p>The feedbacks were deleted</p>
								</div>
								<div class="col-lg-3">
								</div> 
							</div>		
