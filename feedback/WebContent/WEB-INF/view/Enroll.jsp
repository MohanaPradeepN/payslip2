...
<div>
		...
		<hr>
		<%String checkenroll=(String)session.getAttribute("checkenroll");%>
		<%if(checkenroll.equals("Enrolled")){ %>
			<center><p>You have already enrolled.</p></center>
		<%}else if(checkenroll.equals("success")){ %>
			<center><p>Successfully enrolled.</p></center>
		<%} %>
</div>
